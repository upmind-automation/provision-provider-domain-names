...
use Upmind\ProvisionProviders\DomainNames\Centralnic\CustomRequest;
use Upmind\ProvisionProviders\DomainNames\Centralnic\Data\Configuration;
use Upmind\ProvisionProviders\DomainNames\Centralnic\Helper\EppHelper;
...
class Provider extends DomainNames implements ProviderInterface
{
    ...
    /**
     * @var \Upmind\ProvisionProviders\DomainNames\Centralnic\Client
     */
    protected $client;
    ...
    public static function aboutProvider(): AboutData
    {
        return AboutData::create()
            ->setName('Centralnic')
            ->setDescription('Register, transfer, renew and manage Centralnic registry domains such as .uk.com and .hu.com');
    }
    ...
    public function register(RegisterDomainParams $params): DomainResult
    {
        ...
        $infoFrame->setAuthInfo('310h42iSS2@ioutgh4');
